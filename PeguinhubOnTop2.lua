...
local Window = Fluent:CreateWindow({
    Title = "Peguin Hub",
    SubTitle = "Version Beta | By DoanVietCuong",
    TabWidth = 160,
...
Tabs.home:AddButton({
        Title = "Discord",
        Description = "Vô discord giao lưu nhé:>",
        Callback = function()
...
Tabs.home:AddButton({
        Title = "Zalo Chat",
        Description = "Cxgiau lưu thôi !",
        Callback = function()
            setclipboard("https://zalo.me/g/hryzpk469")
        end
    })
...
local Mastery = Tabs.Main:AddSection("Mastery Farm")
    ...
    local ToggleMasteryFruit = Tabs.Main:AddToggle("ToggleMasteryFruit", {
        ...
        Description = "Farm thông thạo trái", 
        Default = false })
...
function InfAbility()
    if _G.SpeedHack then
        if not game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
            ...
            inf.Texture = "rbxassetid://120485703795566"
